        ...
        for def=[0 1]
            ...
            for pod = [ 1]
                ...
                for rr=1:2
                    ...
                    dir='/mnt/sda2/cortes/Results/meetings/06_14_bhp_1_5w_1/';
                    ...
                    %
                    injRate = 1*meter^3/day;
% [I1]=Sub2ind(1,1,1:nz,nx,ny,nz);
% [I2]=Sub2ind(nx,ny,1:nz,nx,ny,nz);
%                                 W = addWell([],G, rock, I1, 'Type', 'rate', ...
%                 'Val', injRate, 'name', 'I', 'radius', .1, 'Comp_i', [1 0]);
...
%               nyi,   ny,     nyi,   ny, ny/2];
wloc     = {Sub2ind(nxi,nyi,1:nz,nx,ny,nz),Sub2ind(nxi,ny,1:nz,nx,ny,nz), ...
            Sub2ind(nx,nyi,1:nz,nx,ny,nz),Sub2ind(nx,ny,1:nz,nx,ny,nz), ...
            Sub2ind(nx/2,ny/2,1:nz,nx,ny,nz)};
wname    = {'P1', 'P2', 'P3', 'P4', 'I'};
sgn      = [ -1 ,  -1 ,  -1 ,  -1 , 1 ];
Comp_iI= [1 0];
Comp_iP= [0 1];
